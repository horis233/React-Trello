...
class List extends React.Component<Props, State> {
	...
	render = () => {
		...
		const { cardComposerIsOpen, cardInEdit, editableCardTitle, isListTitleInEdit, newListTitle } = this.state;
		return (
			<div className="list">
				{isListTitleInEdit ? (
											...
											cardInEdit !== card._id ? (
												...
												<div key={card._id} className="textarea-wrapper">
													<Textarea
														...
														onKeyDown={(event) => this.handleEditKeyDown(event, card.title)}
