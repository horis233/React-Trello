			...
			>
				<div className="modal-textarea-wrapper">
					<Textarea
						...
						spellCheck={false}
					/>
					{selectedDay && <div className="card-details">{selectedDay.toLocaleDateString()}</div>}
				</div>
				...
				{isCalendarOpen && <Calendar selectedDay={selectedDay} handleDayClick={this.handleDayClick} />}
			</Modal>
		);
	}
}
