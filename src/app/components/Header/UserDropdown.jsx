		...
		return (
			<Wrapper className="user-dropdown-wrapper">
				...
				<Menu className="user-dropdown-menu">
					...
					<hr />
					<MenuItem tag="a" rel="noopener noreferrer" href="/auth/signout" className="user-dropdown-item">
						Sign out
					</MenuItem>
				</Menu>
			</Wrapper>
...
const mapStateToProps = ({ user }) => ({
	...
	thumbnail: user ? <img src={user.imageUrl} alt={user.name} /> : <FaUserSecret style={{ fontSize: 26 }} />
});
